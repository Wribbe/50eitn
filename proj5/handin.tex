  ...
  \section{Security architecture -- overview}
    ...
    \subsection{Hardware security layer}
      ...
      \subsubsection{Tamper protection}
        ...
        switch that detects if the casing is open or not.
    ...
    \subsection{Software security layer}
      ...
      \subsubsection{Storage encryption}
        ...
        user-data is encrypted using 256-bit AES. The symmetric key will be a
        combination of a salt, the username and the correct challenge-response
        hash for the specific username and  password combination.
