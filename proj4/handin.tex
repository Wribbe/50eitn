...
Find gadgets so that we have an uninterrupted ROP chain (without NOPs)

Use Windows functions. \escape{https://www.exploit-db.com/exploits/42304/} and \escape{https://www.corelan.be/index.php/2010/06/16/exploit-writing-tutorial-part-10-chaining-dep-with-rop-the-rubikstm-cube/}
