...
\begin{itemize}
	...
	\item Use Windows functions. (\escape{https://www.exploit-db.com/exploits/42304/}) and (\escape{https://www.exploit-db.com/exploits/42186/}) both use Windows function calls (namely to \escape{VirtualProtect()}, which is also described in corelan site linked above (rubik's cube) as a strategy for bypassing DEP.
\end{itemize}
