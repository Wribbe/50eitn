...
\begin{itemize}
	\item Find gadgets so that we have an uninterrupted ROP chain (without e. g. NOPs)
	...
	\item Use Windows functions. (\escape{https://www.exploit-db.com/exploits/42304/}) and (\escape{https://www.exploit-db.com/exploits/42186/}) both use Windows function calls, which is also described in corelan site linked above as a strategy for bypassing DEP.
\end{itemize}
